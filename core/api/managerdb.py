    ...
    def put(self, request, args=None):
        ...
        if args == 'test':
            ...
            try:
                ...
                try:
                    with con_database.SQLgo(ip=ip, user=user, password=password, port=port, db=dbname):
            ...
            try:
                ...
                try:
                    DatabaseList.objects.filter(
                        ...
                        dbname=update_data['dbname'],
                        can_search=update_data['can_search']
                    )
